...
#define _codeSegmentStart 0x800110A0
#define _codeSegmentRomStart 0x00A87000
#define _codeSegmentRomEnd 0x00B8AD30
#define _codeSegmentBssStart 0x80114DD0
#define _codeSegmentBssEnd 0x8012BE30

// RAM: 0x800005A0, ROM: 0x000011A0
void func_800005A0(void* arg0) {
    static DmaRequest code1Info = { 0xDEADBEEF, &statics_START, 0x04206969 };

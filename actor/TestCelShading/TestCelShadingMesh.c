...
Vtx TestCelShadingMesh_Torso_mesh_layer_Opaque_vtx_0[45] = {
	{{{124, 268, -40},0, {1224, 564},{0xA7, 0x20, 0xAB, 0xFF}}},
	{{{126, 214, -97},0, {1348, 576},{0x33, 0x36, 0x99, 0xFF}}},
	{{{0, 214, -97},0, {1388, 279},{0x0, 0x1A, 0x84, 0xFF}}},
	{{{-126, -100, -97},0, {-9, 2020},{0xDF, 0x0, 0x85, 0xFF}}},
	{{{-126, 214, -97},0, {2022, 2020},{0xD4, 0x3E, 0x9A, 0xFF}}},
	{{{126, -100, -97},0, {-9, -10},{0x21, 0x0, 0x85, 0xFF}}},
	{{{0, 214, -97},0, {2022, 753},{0x0, 0x1A, 0x84, 0xFF}}},
	{{{126, 214, -97},0, {2022, -10},{0x33, 0x36, 0x99, 0xFF}}},
	{{{-126, 214, -97},0, {912, 651},{0xD4, 0x3E, 0x9A, 0xFF}}},
	{{{-124, 268, -40},0, {928, 605},{0x79, 0xA, 0x24, 0xFF}}},
	{{{0, 214, -97},0, {839, 623},{0x0, 0x1A, 0x84, 0xFF}}},
	{{{126, 214, 97},0, {1189, 652},{0x33, 0x36, 0x67, 0xFF}}},
	{{{126, -100, 97},0, {1212, 846},{0x21, 0x0, 0x7B, 0xFF}}},
	{{{171, -100, 71},0, {1244, 842},{0x5A, 0x0, 0x5A, 0xFF}}},
	{{{171, 116, 71},0, {1228, 706},{0x54, 0xF1, 0x5E, 0xFF}}},
	{{{197, -100, 26},0, {1276, 839},{0x7B, 0x2, 0x20, 0xFF}}},
	{{{180, 86, 40},0, {1250, 716},{0x79, 0xF9, 0x27, 0xFF}}},
	{{{193, 77, 0},0, {1275, 716},{0x7F, 0xF9, 0x0, 0xFF}}},
	{{{197, -100, -26},0, {1312, 837},{0x7B, 0x4, 0xDF, 0xFF}}},
	{{{180, 86, -40},0, {1298, 702},{0x77, 0xF5, 0xD5, 0xFF}}},
	{{{171, -100, -71},0, {1349, 834},{0x5B, 0x2, 0xA7, 0xFF}}},
	{{{171, 116, -71},0, {1317, 675},{0x54, 0xF0, 0xA2, 0xFF}}},
	{{{126, -100, -97},0, {1388, 831},{0x21, 0x0, 0x85, 0xFF}}},
	{{{126, -100, 97},0, {-11, 2013},{0x21, 0x0, 0x7B, 0xFF}}},
	{{{126, 214, 97},0, {2015, 2013},{0x33, 0x36, 0x67, 0xFF}}},
	{{{0, 214, 97},0, {2015, 1033},{0x0, 0x1A, 0x7C, 0xFF}}},
	{{{-126, 214, 97},0, {2015, -3},{0xD4, 0x3E, 0x66, 0xFF}}},
	{{{-126, -100, 97},0, {-11, -3},{0xDF, 0x0, 0x7B, 0xFF}}},
	{{{124, 268, 40},0, {1205, 607},{0xA7, 0x1D, 0x56, 0xFF}}},
	{{{0, 214, 97},0, {1117, 625},{0x0, 0x1A, 0x7C, 0xFF}}},
	{{{-126, 214, 97},0, {1072, 576},{0xD4, 0x3E, 0x66, 0xFF}}},
	{{{-171, -100, 71},0, {1075, 835},{0xA6, 0x0, 0x5A, 0xFF}}},
	{{{-126, -100, 97},0, {1117, 828},{0xDF, 0x0, 0x7B, 0xFF}}},
	{{{-171, 116, 71},0, {1042, 675},{0xA3, 0xFA, 0x57, 0xFF}}},
	{{{-197, -100, 26},0, {1037, 839},{0x85, 0x2, 0x20, 0xFF}}},
	{{{-180, 86, 40},0, {1022, 702},{0x87, 0xFE, 0x26, 0xFF}}},
	{{{-193, 77, 0},0, {999, 716},{0x81, 0xFD, 0x0, 0xFF}}},
	{{{-197, -100, -26},0, {1002, 841},{0x85, 0x4, 0xDF, 0xFF}}},
	{{{-180, 86, -40},0, {974, 716},{0x88, 0xFB, 0xD6, 0xFF}}},
	{{{-171, -100, -71},0, {968, 843},{0xA5, 0x2, 0xA7, 0xFF}}},
	{{{-171, 116, -71},0, {952, 705},{0xA3, 0xFA, 0xA9, 0xFF}}},
...
Gfx TestCelShadingMesh_Torso_mesh_layer_Opaque_tri_0[] = {
	...
	gsDPPipeSync(),
	gsDPSetCombineLERP(1, TEXEL0, PRIMITIVE_ALPHA, TEXEL0, 0, 0, 0, SHADE, 1, TEXEL0, PRIMITIVE_ALPHA, TEXEL0, 0, 0, 0, SHADE),
...
Vtx TestCelShadingMesh_LArm_mesh_layer_Opaque_vtx_0[42] = {
	{{{-17, -24, -69},0, {1286, 599},{0xFE, 0x7C, 0xE3, 0xFF}}},
	{{{17, 9, -80},0, {1307, 633},{0xC, 0xFF, 0x82, 0xFF}}},
	{{{64, 65, -69},0, {1301, 678},{0x6D, 0xEA, 0xC2, 0xFF}}},
	{{{109, 264, 0},0, {1686, -57},{0x7C, 0xE4, 0x0, 0xFF}}},
	{{{99, 265, 40},0, {1601, -57},{0x6D, 0xE8, 0x3D, 0xFF}}},
	{{{69, 265, 69},0, {1515, -57},{0x44, 0xF5, 0x6B, 0xFF}}},
	{{{64, 65, 69},0, {1507, 1029},{0x7D, 0xF7, 0x15, 0xFF}}},
	{{{29, 267, 80},0, {1430, -57},{0x0, 0x0, 0x7F, 0xFF}}},
	{{{17, 9, 80},0, {1409, 1336},{0xD, 0xFE, 0x7E, 0xFF}}},
	{{{-11, 268, 69},0, {1345, -57},{0xB7, 0xE, 0x67, 0xFF}}},
	{{{-17, -24, 69},0, {1337, 1515},{0xFE, 0x7C, 0x1D, 0xFF}}},
	{{{-40, 269, 40},0, {1259, -57},{0x93, 0x16, 0x3D, 0xFF}}},
	{{{-51, 269, 0},0, {1174, -57},{0x83, 0x15, 0xFF, 0xFF}}},
	{{{-40, 269, -40},0, {1089, -57},{0x92, 0x13, 0xC4, 0xFF}}},
	{{{-17, -24, -69},0, {1011, 1515},{0xFE, 0x7C, 0xE3, 0xFF}}},
	{{{-11, 268, -69},0, {1003, -57},{0xB7, 0xE, 0x99, 0xFF}}},
	{{{29, 267, -80},0, {918, -57},{0x0, 0x0, 0x81, 0xFF}}},
	{{{17, 9, -80},0, {939, 1336},{0xC, 0xFF, 0x82, 0xFF}}},
	{{{69, 265, -69},0, {833, -57},{0x3F, 0xFE, 0x92, 0xFF}}},
	{{{64, 65, -69},0, {841, 1029},{0x6D, 0xEA, 0xC2, 0xFF}}},
	{{{99, 265, -40},0, {748, -57},{0x70, 0xEF, 0xC7, 0xFF}}},
	{{{109, 264, 0},0, {662, -57},{0x7C, 0xE4, 0x0, 0xFF}}},
	{{{124, 268, -40},0, {1224, 564},{0xA7, 0x20, 0xAB, 0xFF}}},
	{{{126, 214, -97},0, {1348, 576},{0x33, 0x36, 0x99, 0xFF}}},
	{{{171, 116, -71},0, {1317, 675},{0x54, 0xF0, 0xA2, 0xFF}}},
	{{{180, 86, -40},0, {1298, 702},{0x77, 0xF5, 0xD5, 0xFF}}},
	{{{180, 86, 40},0, {1592, 1034},{0x79, 0xF9, 0x27, 0xFF}}},
	{{{193, 77, 0},0, {1676, 954},{0x7F, 0xF9, 0x0, 0xFF}}},
	{{{124, 268, 40},0, {1259, 1776},{0xA7, 0x1D, 0x56, 0xFF}}},
	{{{129, 277, 0},0, {1174, 1775},{0x81, 0xFD, 0xFC, 0xFF}}},
	{{{124, 268, -40},0, {1089, 1776},{0xA7, 0x20, 0xAB, 0xFF}}},
	{{{180, 86, -40},0, {756, 1034},{0x77, 0xF5, 0xD5, 0xFF}}},
	{{{180, 86, -40},0, {756, 1034},{0x77, 0xF5, 0xD5, 0xFF}}},
	{{{193, 77, 0},0, {673, 954},{0x7F, 0xF9, 0x0, 0xFF}}},
	{{{180, 86, 40},0, {1250, 716},{0x79, 0xF9, 0x27, 0xFF}}},
	{{{171, 116, 71},0, {1228, 706},{0x54, 0xF1, 0x5E, 0xFF}}},
	{{{126, 214, 97},0, {1189, 652},{0x33, 0x36, 0x67, 0xFF}}},
	{{{124, 268, 40},0, {1205, 607},{0xA7, 0x1D, 0x56, 0xFF}}},
	{{{109, 264, 0},0, {662, -57},{0x7C, 0xE4, 0x0, 0xFF}}},
	{{{64, 65, 69},0, {1238, 703},{0x7D, 0xF7, 0x15, 0xFF}}},
	{{{17, 9, 80},0, {1220, 671},{0xD, 0xFE, 0x7E, 0xFF}}},
...
Vtx TestCelShadingMesh_LArm_mesh_layer_Opaque_vtx_1[10] = {
	{{{-11, 268, -69},0, {999, -7},{0xB7, 0xE, 0x99, 0xFF}}},
	{{{-10, 343, -40},0, {752, 482},{0x9A, 0x28, 0xC0, 0xFF}}},
	{{{19, 342, -69},0, {999, 482},{0xAA, 0x22, 0xA9, 0xFF}}},
	{{{-40, 269, -40},0, {752, -7},{0x92, 0x13, 0xC4, 0xFF}}},
	{{{-21, 343, 0},0, {499, 482},{0x8A, 0x2F, 0x0, 0xFF}}},
	{{{-51, 269, 0},0, {499, -7},{0x83, 0x15, 0xFF, 0xFF}}},
	{{{-40, 269, 40},0, {245, -7},{0x93, 0x16, 0x3D, 0xFF}}},
	{{{-10, 343, 40},0, {245, 482},{0x9A, 0x28, 0x40, 0xFF}}},
...
Vtx TestCelShadingMesh_RArm_mesh_layer_Opaque_vtx_1[42] = {
	...
	{{{-107, 280, 0},0, {637, -55},{0x82, 0xED, 0x0, 0xFF}}},
	{{{-96, 281, 40},0, {722, -55},{0x93, 0xF0, 0x3F, 0xFF}}},
	{{{-67, 283, 69},0, {808, -55},{0xBF, 0xF8, 0x6D, 0xFF}}},
	{{{-54, 83, 69},0, {816, 1023},{0x97, 0xF8, 0x47, 0xFF}}},
	{{{-27, 285, 80},0, {893, -55},{0x0, 0x0, 0x7F, 0xFF}}},
	{{{-5, 29, 80},0, {914, 1327},{0xFA, 0xE, 0x7E, 0xFF}}},
	{{{13, 288, 69},0, {978, -55},{0x49, 0xB, 0x68, 0xFF}}},
	{{{30, -3, 69},0, {986, 1505},{0xBB, 0x54, 0x41, 0xFF}}},
	{{{42, 290, 40},0, {1064, -55},{0x6F, 0xC, 0x3C, 0xFF}}},
	{{{53, 291, 0},0, {1149, -55},{0x7F, 0x8, 0xFF, 0xFF}}},
	{{{42, 290, -40},0, {1234, -55},{0x70, 0xA, 0xC5, 0xFF}}},
	{{{30, -3, -69},0, {1312, 1505},{0xBB, 0x55, 0xC0, 0xFF}}},
	{{{13, 288, -69},0, {1320, -55},{0x49, 0xB, 0x98, 0xFF}}},
	{{{-27, 285, -80},0, {1405, -55},{0x0, 0x0, 0x81, 0xFF}}},
	{{{-5, 29, -80},0, {1384, 1327},{0xFB, 0xF, 0x82, 0xFF}}},
	{{{-67, 283, -69},0, {1490, -55},{0xC1, 0xFC, 0x92, 0xFF}}},
	{{{-54, 83, -69},0, {1482, 1023},{0xAE, 0xF5, 0x9F, 0xFF}}},
	{{{-96, 281, -40},0, {1576, -55},{0x91, 0xF3, 0xC3, 0xFF}}},
	{{{-107, 280, 0},0, {1661, -55},{0x82, 0xED, 0x0, 0xFF}}},
	{{{-124, 268, -40},0, {928, 605},{0x79, 0xA, 0x24, 0xFF}}},
	{{{-126, 214, -97},0, {912, 651},{0xD4, 0x3E, 0x9A, 0xFF}}},
	{{{-171, 116, -71},0, {952, 705},{0xA3, 0xFA, 0xA9, 0xFF}}},
	{{{-180, 86, -40},0, {974, 716},{0x88, 0xFB, 0xD6, 0xFF}}},
	{{{-193, 77, 0},0, {648, 948},{0x81, 0xFD, 0x0, 0xFF}}},
	{{{-180, 86, 40},0, {731, 1027},{0x87, 0xFE, 0x26, 0xFF}}},
	{{{-124, 268, 40},0, {1064, 1764},{0x7A, 0x7, 0xDE, 0xFF}}},
	{{{-129, 277, 0},0, {1149, 1762},{0x7E, 0xEE, 0xFD, 0xFF}}},
	{{{-124, 268, -40},0, {1234, 1764},{0x79, 0xA, 0x24, 0xFF}}},
	{{{-180, 86, -40},0, {1567, 1027},{0x88, 0xFB, 0xD6, 0xFF}}},
	{{{-180, 86, -40},0, {1567, 1027},{0x88, 0xFB, 0xD6, 0xFF}}},
	{{{-193, 77, 0},0, {1650, 948},{0x81, 0xFD, 0x0, 0xFF}}},
	{{{-180, 86, 40},0, {1022, 702},{0x87, 0xFE, 0x26, 0xFF}}},
	{{{-171, 116, 71},0, {1042, 675},{0xA3, 0xFA, 0x57, 0xFF}}},
	{{{-126, 214, 97},0, {1072, 576},{0xD4, 0x3E, 0x66, 0xFF}}},
	{{{-124, 268, 40},0, {948, 562},{0x7A, 0x7, 0xDE, 0xFF}}},
	{{{-107, 280, 0},0, {1661, -55},{0x82, 0xED, 0x0, 0xFF}}},
	{{{-54, 83, 69},0, {1026, 678},{0x97, 0xF8, 0x47, 0xFF}}},
	{{{-5, 29, 80},0, {1031, 633},{0xFA, 0xE, 0x7E, 0xFF}}},
...
Gfx mat_TestCelShadingMesh_blue_layerOpaque[] = {
	...
	gsDPSetBlendColor(255, 255, 255, 98),

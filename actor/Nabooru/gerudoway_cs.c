...
s32 NabooruSecondHalfCS[] = {
	...
	CS_TEXT_LIST(6),
		...
		CS_TEXT_LEARN_SONG(12, 275, 280, 0x0000),
		CS_TEXT_LEARN_SONG(25, 290, 295, 0x0000),
	...
	CS_CAM_POS_LIST(250, 331),
		CS_CAM_POS(0, 0, 0, 0x42700000, 1956, 36, -675, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, 1956, 36, -675, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, 1956, 36, -675, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, 1956, 36, -675, 0),
		CS_CAM_POS(-1, 0, 0, 0x0, 0, 0, 0, 0),
	...
	CS_CAM_POS_LIST(300, 511),
		...
		CS_CAM_POS(0, 0, 0, 0x42700000, 1941, 32, -686, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, 1941, 33, -686, 0),
		CS_CAM_POS(-1, 0, 0, 0x0, 0, 0, 0, 0),
	...
	CS_CAM_FOCUS_POINT_LIST(250, 350),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42700000, 1949, 33, -730, 0),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42700000, 1949, 33, -730, 0),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42700000, 1949, 33, -730, 0),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42700000, 1949, 33, -730, 0),
		CS_CAM_FOCUS_POINT(-1, 0, 0, 0x0, 0, 0, 0, 0),
	CS_CAM_FOCUS_POINT_LIST(285, 385),
		...
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42700000, 1908, 34, -690, 0),
		CS_CAM_FOCUS_POINT(-1, 0, 0, 0x0, 0, 0, 0, 0),
	CS_CAM_FOCUS_POINT_LIST(300, 530),
		...
		CS_CAM_FOCUS_POINT(0, 0, 25, 0x42700000, 1936, 32, -704, 0),
		CS_CAM_FOCUS_POINT(0, 0, 50, 0x42700000, 1908, 29, -686, 0),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42700000, 1907, 29, -685, 0),
		CS_CAM_FOCUS_POINT(-1, 0, 0, 0x0, 0, 0, 0, 0),

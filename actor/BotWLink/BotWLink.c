...
static const HairPhysBasic  tasselsBasic  =  {0.002f,500.0f,  3.0f,120.0f, 0.02f, 0.97f, 0.010f, 1, 1, 0};
static const HairPhysDouble tasselsLDouble= {{0.001f,999.9f,  2.0f,120.0f, 0.07f, 0.97f, 0.015f, 1, 0, 0}, &tasselLLimits};
static const HairPhysDouble tasselsRDouble= {{0.001f,999.9f,  2.0f,120.0f, 0.07f, 0.97f, 0.015f, 1, 0, 0}, &tasselRLimits};
static const HairPhysBasic  tunicBasic    =  {0.002f,500.0f,  5.0f,200.0f, 0.10f, 0.92f, 0.015f, 2, 1, 1};

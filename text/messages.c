...
DECLARE_MESSAGE(0x0FA0, BOX_CREDITS, POS_VARIABLE,
    QUICKTEXT_ENABLE NEWLINE NEWLINE NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") "Assets, Toolchain, and Performance" NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") "Copyright (C) 2019-2022" NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") "The Triforce% Team"
    QUICKTEXT_DISABLE FADE2("\x00\x30")
)

DECLARE_MESSAGE(0x0FA1, BOX_CREDITS, POS_VARIABLE,
    QUICKTEXT_ENABLE NEWLINE NEWLINE NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") "The Legend of ZELDA: Ocarina of Time" NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") "Copyright (C) 1998" NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") "Nintendo"
    QUICKTEXT_DISABLE FADE2("\x00\x30")
)

...
DECLARE_MESSAGE(0x0F00, BOX_CREDITS, POS_VARIABLE,
    ...
    QUICKTEXT_DISABLE FADE2("\x00\x40")
)

DECLARE_MESSAGE(0x0F01, BOX_CREDITS, POS_VARIABLE,
    QUICKTEXT_ENABLE NEWLINE NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") SHIFT("\x18") "Director" NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") SHIFT("\x36") "SAURAEN" NEWLINE NEWLINE NEWLINE
    NEWLINE
    SHIFT("\x24") SHIFT("\x18") "RTA Speedrunner" NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") SHIFT("\x36") "SAVESTATE"
    QUICKTEXT_DISABLE FADE2("\x00\x40")
)
...
DECLARE_MESSAGE(0x0F10, BOX_CREDITS, POS_VARIABLE,
    ...
    SHIFT("\x24") SHIFT("\x42") "ASSET UNIT" NEWLINE NEWLINE NEWLINE
    NEWLINE
...
DECLARE_MESSAGE(0x0F21, BOX_CREDITS, POS_VARIABLE,
    ...
    SHIFT("\x24") SHIFT("\x36") "SAURAEN" NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") SHIFT("\x36") "AEROARTWORK" NEWLINE NEWLINE NEWLINE
    NEWLINE
    SHIFT("\x24") SHIFT("\x18") "Motion Actor" NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") SHIFT("\x36") "TBD"
    QUICKTEXT_DISABLE FADE2("\x00\x40")
)
...
DECLARE_MESSAGE(0x0F40, BOX_CREDITS, POS_VARIABLE,
    QUICKTEXT_ENABLE NEWLINE NEWLINE
    SHIFT("\x24") SHIFT("\x42") "PROGRAM UNIT" NEWLINE NEWLINE NEWLINE
    NEWLINE
...
DECLARE_MESSAGE(0x0F50, BOX_CREDITS, POS_VARIABLE,
    ...
    SHIFT("\x24") SHIFT("\x18") "Cel Shading" NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") SHIFT("\x36") "SAURAEN" NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") SHIFT("\x36") "GLANK"
    QUICKTEXT_DISABLE FADE2("\x00\x40")
)

DECLARE_MESSAGE(0x0F51, BOX_CREDITS, POS_VARIABLE,
    QUICKTEXT_ENABLE NEWLINE NEWLINE NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") SHIFT("\x18") "Bootstrapper Chain" NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") SHIFT("\x36") "SAURAEN" NEWLINE NEWLINE NEWLINE
    NEWLINE
    SHIFT("\x24") SHIFT("\x18") "Hyperspeed Loader" NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") SHIFT("\x36") "TERUSTHEBIRD" NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") SHIFT("\x36") "SAURAEN"
    QUICKTEXT_DISABLE FADE2("\x00\x40")
)
...
DECLARE_MESSAGE(0x0F70, BOX_CREDITS, POS_VARIABLE,
    ...
    SHIFT("\x24") SHIFT("\x42") "COMMUNITY UNIT" NEWLINE NEWLINE
    NEWLINE
    SHIFT("\x24") SHIFT("\x18") "Partner Creators" NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") SHIFT("\x36") "SWANKYBOX" NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") SHIFT("\x36") "SCOTTFALCO" NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") SHIFT("\x36") "RETRO GAME" NEWLINE NEWLINE
    SHIFT("\x24") SHIFT("\x50")     "MECHANICS EXPLAINED" NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") SHIFT("\x36") "TBD" NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") SHIFT("\x36") "TBD"
    QUICKTEXT_DISABLE FADE2("\x00\x50")
)
...
DECLARE_MESSAGE(0x0F72, BOX_CREDITS, POS_VARIABLE,
    ...
    SHIFT("\x24") SHIFT("\x18") "OST Published By" NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") SHIFT("\x36") "SIIVAGUNNER"
    QUICKTEXT_DISABLE FADE2("\x00\x40")
)
...
DECLARE_MESSAGE(0x0F91, BOX_CREDITS, POS_VARIABLE,
    QUICKTEXT_ENABLE NEWLINE NEWLINE NEWLINE NEWLINE NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") SHIFT("\x18") "Executive Producer" NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") SHIFT("\x36") "DWANGOAC"
    QUICKTEXT_DISABLE FADE2("\x00\x40")
)
...
DECLARE_MESSAGE(0x0F92, BOX_CREDITS, POS_VARIABLE,
    QUICKTEXT_ENABLE NEWLINE NEWLINE NEWLINE NEWLINE NEWLINE
    SHIFT("\x42") "PRESENTED AT" NEWLINE NEWLINE
    SHIFT("\x28") "Summer Games Done Quick 2022" 
    QUICKTEXT_DISABLE FADE2("\x00\x40")
)

DECLARE_MESSAGE(0x0FA0, BOX_CREDITS, POS_VARIABLE,
    QUICKTEXT_ENABLE NEWLINE NEWLINE NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") SHIFT("\x18") "Assets, Toolchain, and Performance" NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") SHIFT("\x18") "Copyright (C) 2019-2022" NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") SHIFT("\x18") "The Triforce% Team"
    QUICKTEXT_DISABLE FADE2("\x00\x30")
)

DECLARE_MESSAGE(0x0FA1, BOX_CREDITS, POS_VARIABLE,
    QUICKTEXT_ENABLE NEWLINE NEWLINE NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") SHIFT("\x18") "The Legend of ZELDA: Ocarina of Time" NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") SHIFT("\x18") "Copyright (C) 1998" NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") SHIFT("\x18") "Nintendo"
    QUICKTEXT_DISABLE FADE2("\x00\x30")
)

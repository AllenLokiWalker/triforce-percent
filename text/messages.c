...
DECLARE_MESSAGE(0x0F00, BOX_CREDITS, POS_VARIABLE,
    ...
    SHIFT("\x24") SHIFT("\x46") "TRIFORCE%" NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") SHIFT("\x28") "OoT ACE Showcase" 
    QUICKTEXT_DISABLE FADE2("\x00\x35")
)
...
DECLARE_MESSAGE(0x0F70, BOX_CREDITS, POS_VARIABLE,
    ...
    SHIFT("\x14") SHIFT("\x26") "SCOTTFALCO" NEWLINE NEWLINE NEWLINE
    SHIFT("\x14") SHIFT("\x26") "RETRO GAME" NEWLINE NEWLINE
    SHIFT("\x14") SHIFT("\x40")     "MECHANICS EXPLAINED" NEWLINE NEWLINE NEWLINE
    SHIFT("\x14") SHIFT("\x26") "TBD" NEWLINE NEWLINE NEWLINE
    SHIFT("\x14") SHIFT("\x26") "TBD" NEWLINE NEWLINE NEWLINE
    SHIFT("\x14") SHIFT("\x26") "TBD"
    QUICKTEXT_DISABLE FADE2("\x00\x35")
)
...
DECLARE_MESSAGE(0x0F91, BOX_CREDITS, POS_VARIABLE,
    QUICKTEXT_ENABLE NEWLINE NEWLINE NEWLINE NEWLINE NEWLINE NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") SHIFT("\x28") "Executive Producer" NEWLINE NEWLINE NEWLINE
    SHIFT("\x24") SHIFT("\x46") "DWANGOAC"
    QUICKTEXT_DISABLE FADE2("\x00\x35")
)

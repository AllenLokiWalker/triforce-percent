...
s32 HyruleFieldFlyover[] = {
	...
	CS_CAM_POS_LIST(175, 616),
		CS_CAM_POS(0, 0, 0, 0x42700000, -1040, -367, 12645, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, -915, -365, 12538, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, -200, -187, 11321, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, -240, -249, 11128, 0),
		CS_CAM_POS(-1, 0, 0, 0x0, 0, 0, 0, 0),
	...
	CS_CAM_FOCUS_POINT_LIST(175, 715),
		CS_CAM_FOCUS_POINT(0, 0, 100, 0x42700000, -1006, -368, 12689, 0),
		CS_CAM_FOCUS_POINT(0, 0, 140, 0x42700000, -872, -375, 12573, 0),
		CS_CAM_FOCUS_POINT(0, 0, 100, 0x42700000, -145, -186, 11316, 0),
		CS_CAM_FOCUS_POINT(0, 0, 100, 0x42700000, -179, -245, 11122, 0),
		CS_CAM_FOCUS_POINT(-1, 0, 0, 0x0, 0, 0, 0, 0),
	CS_END(),
};

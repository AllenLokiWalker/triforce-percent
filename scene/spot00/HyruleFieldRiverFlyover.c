...
s32 Something[] = {
	CS_BEGIN_CUTSCENE(6, 266),
	CS_TERMINATOR(84, 99, 100),
	CS_TEXT_LIST(3),
		CS_TEXT_DISPLAY_TEXTBOX(0x0F00, 20, 90, 0x0000, 0x0000, 0x0000),
		CS_TEXT_DISPLAY_TEXTBOX(0x0F01, 105, 175, 0x0000, 0x0000, 0x0000),
		CS_TEXT_DISPLAY_TEXTBOX(0x0F02, 195, 265, 0x0000, 0x0000, 0x0000),

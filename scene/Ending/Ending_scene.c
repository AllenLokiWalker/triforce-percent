...
s32 FinaleCS[] = {
	...
	CS_CAM_POS_LIST(490, 1314),
		...
		CS_CAM_POS(0, 0, 0, 0x42700000, 282, 1, 236, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, 273, 2, 135, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, 172, 4, 144, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, 181, 6, 245, 0),
	...
	CS_CAM_POS_LIST(1243, 1784),
		...
		CS_CAM_POS(0, 0, 0, 0x42340000, 386, -1, 308, 0),
		CS_CAM_POS(0, 0, 0, 0x42340000, 386, -1, 308, 0),
		CS_CAM_POS(0, 0, 0, 0x42340000, 386, -1, 308, 0),
		CS_CAM_POS(-1, 0, 0, 0x0, 0, 0, 0, 0),
	CS_CAM_POS_LIST(1622, 1873),
		...
		CS_CAM_POS(0, 0, 0, 0x42700000, 432, -6, 307, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, 432, -6, 307, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, 432, -6, 307, 0),
		CS_CAM_POS(-1, 0, 0, 0x0, 0, 0, 0, 0),
	...
	CS_CAM_FOCUS_POINT_LIST(490, 1333),
		...
		CS_CAM_FOCUS_POINT(0, 0, 50, 0x42700000, 227, -4, 190, 0),
		CS_CAM_FOCUS_POINT(0, 0, 50, 0x42700000, 227, -4, 190, 0),
		CS_CAM_FOCUS_POINT(0, 0, 50, 0x42700000, 227, -3, 191, 0),
		CS_CAM_FOCUS_POINT(0, 0, 50, 0x42700000, 227, -5, 190, 0),
		CS_CAM_FOCUS_POINT(0, 0, 48, 0x42700000, 227, -8, 190, 0),
	...
	CS_CAM_FOCUS_POINT_LIST(1243, 1803),
		...
		CS_CAM_FOCUS_POINT(0, 0, 60, 0x42500000, 367, -3, 366, 0),
		CS_CAM_FOCUS_POINT(0, 0, 50, 0x42340000, 399, -2, 329, 0),
		CS_CAM_FOCUS_POINT(0, 0, 50, 0x42340000, 399, -2, 329, 0),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42340000, 399, -2, 329, 0),
		CS_CAM_FOCUS_POINT(-1, 0, 0, 0x0, 0, 0, 0, 0),
	...
	CS_CAM_FOCUS_POINT_LIST(1830, 2680),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42700000, 186, 77, -266, 0),
		CS_CAM_FOCUS_POINT(0, 0, 70, 0x42700000, 324, -59, -32, 0),
		CS_CAM_FOCUS_POINT(0, 0, 270, 0x42700000, 957, 127, 577, 0),
		CS_CAM_FOCUS_POINT(0, 0, 450, 0x42700000, 340, 127, 816, 0),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42700000, -134, 127, 1088, 0),
		CS_CAM_FOCUS_POINT(-1, 0, 0, 0x0, 0, 0, 0, 0),
	...
	CS_NPC_ACTION_LIST(17, 16),
		...
		CS_NPC_ACTION(0x0004, 1155, 1380, 0x0, 0x5ac8, 0x0, 340, -50, 429, 340, -50, 429, 0, 0, 0),
	...
	CS_NPC_ACTION_LIST(36, 4),
		...
		CS_NPC_ACTION(0x0001, 1188, 1271, 0x0, 0x0, 0x0, 437, -50, 354, 437, -50, 354, 0, 0, 0),
		CS_NPC_ACTION(0x0002, 1271, 1333, 0x0, 0x0, 0x0, 437, -50, 354, 437, -50, 354, 0, 0, 0),

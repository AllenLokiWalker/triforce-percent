...
s32 FinaleCS[] = {
	...
	CS_CAM_POS_LIST(210, 653),
		...
		CS_CAM_POS(-1, 0, 0, 0x0, 0, 0, 0, 0),
	CS_CAM_POS_LIST(490, 1309),
		CS_CAM_POS(0, 0, 0, 0x42340000, 265, -34, 222, 0),
		CS_CAM_POS(0, 0, 0, 0x42340000, 265, -34, 222, 0),
		CS_CAM_POS(0, 0, 0, 0x42340000, 265, -34, 222, 0),
		CS_CAM_POS(0, 0, 0, 0x42340000, 265, -34, 222, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, 244, 0, 205, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, 272, 2, 228, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, 270, 2, 139, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, 176, 4, 147, 0),
	...
	CS_CAM_POS_LIST(2920, 3001),
		CS_CAM_POS(0, 0, 0, 0x42200000, 475, 6, 365, 0),
		CS_CAM_POS(0, 0, 0, 0x42200000, 475, 6, 365, 0),
		CS_CAM_POS(0, 0, 0, 0x42200000, 475, 6, 365, 0),
		CS_CAM_POS(0, 0, 0, 0x42200000, 475, 6, 365, 0),
		CS_CAM_POS(-1, 0, 0, 0x0, 0, 0, 0, 0),
	...
	CS_CAM_FOCUS_POINT_LIST(210, 702),
		...
		CS_CAM_FOCUS_POINT(-1, 0, 0, 0x0, 0, 0, 0, 0),
	CS_CAM_FOCUS_POINT_LIST(490, 1328),
		CS_CAM_FOCUS_POINT(0, 0, 50, 0x42340000, 244, -55, 205, 0),
		CS_CAM_FOCUS_POINT(0, 0, 25, 0x42340000, 244, -55, 205, 0),
		CS_CAM_FOCUS_POINT(0, 0, 25, 0x42340000, 244, -55, 205, 0),
		CS_CAM_FOCUS_POINT(0, 0, 75, 0x42340000, 244, -55, 205, 0),
	...
	CS_CAM_FOCUS_POINT_LIST(2920, 3020),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42200000, 419, 0, 372, 0),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42200000, 419, 0, 372, 0),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42200000, 419, 0, 372, 0),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42200000, 419, 0, 372, 0),
		CS_CAM_FOCUS_POINT(-1, 0, 0, 0x0, 0, 0, 0, 0),
	...
	CS_NPC_ACTION_LIST(36, 4),
		...
		CS_NPC_ACTION(0x0001, 1188, 1265, 0x0, 0x0, 0x0, 437, -50, 354, 437, -50, 354, 0, 0, 0),
		CS_NPC_ACTION(0x0002, 1265, 1333, 0x0, 0x0, 0x0, 437, -50, 354, 437, -50, 354, 0, 0, 0),

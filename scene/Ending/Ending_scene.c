...
s32 FinaleCS[] = {
	...
	CS_CAM_POS_LIST(0, 531),
		CS_CAM_POS(0, 0, 0, 0x42340000, 35, 34, 30, 0),
		CS_CAM_POS(0, 0, 0, 0x42340000, 35, 34, 30, 0),
	...
	CS_CAM_POS_LIST(210, 653),
		...
		CS_CAM_POS(-1, 0, 0, 0x0, 0, 0, 0, 0),
	CS_CAM_POS_LIST(490, 1314),
		CS_CAM_POS(0, 0, 0, 0x42700000, 247, -45, 207, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, 247, -45, 207, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, 247, -45, 207, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, 247, -45, 207, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, 247, -4, 207, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, 282, 6, 236, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, 273, 6, 135, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, 172, 8, 144, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, 181, 8, 245, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, 234, 8, 261, 0),
		CS_CAM_POS(0, 0, 0, 0x42480000, 321, 8, 335, 0),
		CS_CAM_POS(0, 0, 0, 0x42480000, 350, -5, 477, 0),
		CS_CAM_POS(0, 0, 0, 0x42480000, 246, 8, 503, 0),
	...
	CS_CAM_POS_LIST(1243, 1774),
		...
		CS_CAM_POS(0, 0, 0, 0x42340000, 318, -1, 351, 0),
		CS_CAM_POS(0, 0, 0, 0x42340000, 318, -1, 351, 0),
		CS_CAM_POS(0, 0, 0, 0x42340000, 318, -1, 351, 0),
		CS_CAM_POS(-1, 0, 0, 0x0, 0, 0, 0, 0),
	...
	CS_CAM_FOCUS_POINT_LIST(0, 550),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42340000, 27, 26, 22, 0),
		CS_CAM_FOCUS_POINT(0, 0, 80, 0x42340000, 27, 26, 22, 0),
		CS_CAM_FOCUS_POINT(0, 0, 35, 0x42700000, 78, 39, 65, 0),
	...
	CS_CAM_FOCUS_POINT_LIST(210, 702),
		...
		CS_CAM_FOCUS_POINT(-1, 0, 0, 0x0, 0, 0, 0, 0),
	CS_CAM_FOCUS_POINT_LIST(490, 1333),
		CS_CAM_FOCUS_POINT(0, 0, 50, 0x42700000, 227, -66, 190, 0),
		CS_CAM_FOCUS_POINT(0, 0, 30, 0x42700000, 227, -66, 190, 0),
		CS_CAM_FOCUS_POINT(0, 0, 30, 0x42700000, 227, -66, 190, 0),
		CS_CAM_FOCUS_POINT(0, 0, 70, 0x42700000, 227, -66, 190, 0),
		CS_CAM_FOCUS_POINT(0, 0, 100, 0x42700000, 227, -3, 190, 0),
		CS_CAM_FOCUS_POINT(0, 0, 50, 0x42700000, 227, -2, 190, 0),
		CS_CAM_FOCUS_POINT(0, 0, 50, 0x42700000, 227, -2, 190, 0),
		CS_CAM_FOCUS_POINT(0, 0, 50, 0x42700000, 227, -2, 191, 0),
		CS_CAM_FOCUS_POINT(0, 0, 50, 0x42700000, 227, -9, 190, 0),
		CS_CAM_FOCUS_POINT(0, 0, 48, 0x42700000, 227, -9, 190, 0),
		CS_CAM_FOCUS_POINT(0, 0, 70, 0x42480000, 322, -9, 271, 0),
		CS_CAM_FOCUS_POINT(0, 0, 55, 0x42480000, 351, -9, 432, 0),
		CS_CAM_FOCUS_POINT(0, 0, 65, 0x42480000, 303, -9, 461, 0),
	...
	CS_CAM_FOCUS_POINT_LIST(1243, 1793),
		...
		CS_CAM_FOCUS_POINT(0, 0, 50, 0x42500000, 367, -3, 366, 0),
		CS_CAM_FOCUS_POINT(0, 0, 50, 0x42340000, 342, -2, 355, 0),
		CS_CAM_FOCUS_POINT(0, 0, 50, 0x42340000, 342, -2, 355, 0),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42340000, 342, -2, 355, 0),
		CS_CAM_FOCUS_POINT(-1, 0, 0, 0x0, 0, 0, 0, 0),
	...
	CS_NPC_ACTION_LIST(17, 16),
		CS_NPC_ACTION(0x0000, 0, 440, 0x0, 0x238e, 0x0, 227, -50, 190, 227, -50, 190, 0, 0, 0),
		CS_NPC_ACTION(0x0009, 440, 491, 0x0, 0x238e, 0x0, 227, -50, 190, 227, -50, 190, 0, 0, 0),
		...
		CS_NPC_ACTION(0x0002, 900, 982, 0x0, 0x238e, 0x0, 227, -50, 190, 318, -50, 266, 0, 0, 0),
		CS_NPC_ACTION(0x0002, 982, 1073, 0x0, 0x5b6, 0x0, 318, -50, 266, 340, -50, 429, 0, 0, 0),
		CS_NPC_ACTION(0x0001, 1073, 1155, 0x0, 0x567, 0x0, 340, -50, 429, 340, -50, 429, 0, 0, 0),
		CS_NPC_ACTION(0x0004, 1155, 1400, 0x0, 0x5ac8, 0x0, 340, -50, 429, 340, -50, 429, 0, 0, 0),
		CS_NPC_ACTION(0x0002, 1400, 1467, 0x0, 0x5a80, 0x0, 340, -50, 429, 399, -50, 376, 0, 0, 0),
		CS_NPC_ACTION(0x0001, 1467, 1680, 0x0, 0x5a80, 0x0, 399, -50, 376, 399, -50, 376, 0, 0, 0),
	...
	CS_NPC_ACTION_LIST(36, 3),
		...
		CS_NPC_ACTION(0x0001, 1188, 1333, 0x0, 0x0, 0x0, 437, -50, 354, 437, -50, 354, 0, 0, 0),
		CS_NPC_ACTION(0x0002, 1333, 1370, 0x0, 0x0, 0x0, 437, -50, 354, 437, -50, 254, 0, 0, 0),
	CS_END(),
};

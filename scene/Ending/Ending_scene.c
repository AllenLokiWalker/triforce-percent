...
s32 FinaleCS[] = {
	...
	CS_CAM_POS_LIST(1830, 2771),
		CS_CAM_POS(0, 0, 0, 0x42700000, 1251, 133, 144, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, 770, 133, 432, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, 289, 133, 720, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, -193, 133, 1009, 0),
		CS_CAM_POS(-1, 0, 0, 0x0, 0, 0, 0, 0),
	...
	CS_CAM_POS_LIST(2920, 3001),
		CS_CAM_POS(0, 0, 0, 0x42480000, 464, 6, 367, 0),
		CS_CAM_POS(0, 0, 0, 0x42480000, 464, 6, 367, 0),
		CS_CAM_POS(0, 0, 0, 0x42480000, 464, 6, 367, 0),
		CS_CAM_POS(0, 0, 0, 0x42480000, 464, 6, 367, 0),
		CS_CAM_POS(-1, 0, 0, 0x0, 0, 0, 0, 0),
	...
	CS_CAM_FOCUS_POINT_LIST(1830, 2790),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42700000, 1539, 133, 626, 0),
		CS_CAM_FOCUS_POINT(0, 0, 450, 0x42700000, 1058, 133, 914, 0),
		CS_CAM_FOCUS_POINT(0, 0, 450, 0x42700000, 577, 133, 1202, 0),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42700000, 95, 133, 1490, 0),
		CS_CAM_FOCUS_POINT(-1, 0, 0, 0x0, 0, 0, 0, 0),
	...
	CS_CAM_FOCUS_POINT_LIST(2424, 3184),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42700000, 1542, 122, 623, 0),
		CS_CAM_FOCUS_POINT(0, 0, 350, 0x42700000, 1060, 123, 911, 0),
		CS_CAM_FOCUS_POINT(0, 0, 350, 0x42700000, 579, 125, 1198, 0),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42700000, 97, 126, 1485, 0),
		CS_CAM_FOCUS_POINT(-1, 0, 0, 0x0, 0, 0, 0, 0),
	...
	CS_CAM_FOCUS_POINT_LIST(2920, 3020),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42480000, 408, 0, 373, 0),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42480000, 408, 0, 373, 0),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42480000, 408, 0, 373, 0),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42480000, 408, 0, 373, 0),
		CS_CAM_FOCUS_POINT(-1, 0, 0, 0x0, 0, 0, 0, 0),

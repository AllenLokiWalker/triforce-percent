...
s32 NbColossusCS[] = {
	...
	CS_CAM_FOCUS_POINT_LIST(0, 450),
		...
		CS_CAM_FOCUS_POINT(0, 0, 60, 0x42700000, 3510, 119, -253, 0),
		CS_CAM_FOCUS_POINT(0, 0, 60, 0x42700000, 1178, 227, -22, 0),
		CS_CAM_FOCUS_POINT(0, 0, 40, 0x42700000, 635, 330, -22, 0),
		CS_CAM_FOCUS_POINT(0, 0, 40, 0x42a00000, 44, -24, 12, 0),
		CS_CAM_FOCUS_POINT(0, 0, 50, 0x42a00000, -789, 8, 12, 0),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42a00000, -809, 8, 12, 0),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42a00000, -799, 8, 12, 0),
		CS_CAM_FOCUS_POINT(-1, 0, 0, 0x0, 0, 0, 0, 0),
	CS_CAM_FOCUS_POINT_LIST(355, 515),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42700000, -1636, 742, 398, 0),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42700000, -1644, 737, 403, 0),
		CS_CAM_FOCUS_POINT(0, 0, 30, 0x42700000, -1643, 740, 386, 0),
		CS_CAM_FOCUS_POINT(0, 0, 30, 0x42700000, -1641, 727, -353, 0),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42700000, -1641, 727, -359, 0),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42700000, -1641, 727, -364, 0),
		CS_CAM_FOCUS_POINT(-1, 0, 0, 0x0, 0, 0, 0, 0),

...
s32 HauntedWastelandFlyover[] = {
	...
	CS_CAM_POS_LIST(0, 561),
		...
		CS_CAM_POS(0, 0, 0, 0x42f00000, 4167, 287, -1620, 0),
		CS_CAM_POS(0, 0, 0, 0x42b40000, 4720, 292, -1651, 0),
	...
	CS_CAM_FOCUS_POINT_LIST(0, 680),
		...
		CS_CAM_FOCUS_POINT(0, 0, 120, 0x42f00000, 4223, 288, -1621, 0),
		CS_CAM_FOCUS_POINT(0, 0, 120, 0x42b40000, 4776, 293, -1653, 0),

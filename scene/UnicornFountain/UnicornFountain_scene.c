...
s32 UnicornFountain_scene_header00_cutscene[] = {
	...
	CS_CAM_POS_LIST(445, 526),
		CS_CAM_POS(0, 0, 0, 0x42700000, 93, 27, -633, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, 93, 27, -633, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, 93, 27, -633, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, 93, 27, -633, 0),
		CS_CAM_POS(-1, 0, 0, 0x0, 0, 0, 0, 0),
	...
	CS_CAM_POS_LIST(623, 824),
		...
		CS_CAM_POS(0, 0, 0, 0x42700000, -7, 34, -626, 0),
		CS_CAM_POS(0, 0, 0, 0x42b40000, -2, 36, -607, 0),
		CS_CAM_POS(0, 0, 0, 0x42b40000, -2, 36, -607, 0),
		CS_CAM_POS(-1, 0, 0, 0x0, 0, 0, 0, 0),
	...
	CS_CAM_FOCUS_POINT_LIST(445, 545),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42700000, 44, 27, -608, 0),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42700000, 44, 27, -608, 0),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42700000, 44, 27, -608, 0),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42700000, 44, 27, -608, 0),
		CS_CAM_FOCUS_POINT(-1, 0, 0, 0x0, 0, 0, 0, 0),
	...
	CS_CAM_FOCUS_POINT_LIST(623, 843),
		...
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42700000, -2, 29, -598, 0),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42b40000, -1, 34, -593, 0),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42b40000, -1, 35, -593, 0),
		CS_CAM_FOCUS_POINT(-1, 0, 0, 0x0, 0, 0, 0, 0),

...
s32 UnicornFountain_scene_header00_cutscene[] = {
	...
	CS_PLAY_BGM_LIST(1),
		CS_PLAY_BGM(0x38, 455, 1, 0, 0, 0, 0, 0, 0, 0, 0),
	...
	CS_CAM_POS_LIST(205, 376),
		...
		CS_CAM_POS(0, 0, 0, 0x42700000, -82, 152, -602, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, 56, 200, -672, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, 63, 202, -701, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, 62, 202, -705, 0),
		CS_CAM_POS(-1, 0, 0, 0x0, 0, 0, 0, 0),
	...
	CS_CAM_POS_LIST(445, 526),
		CS_CAM_POS(0, 0, 0, 0x42700000, 93, 39, -634, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, 93, 39, -634, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, 93, 39, -634, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, 93, 39, -634, 0),
		CS_CAM_POS(-1, 0, 0, 0x0, 0, 0, 0, 0),
	...
	CS_CAM_POS_LIST(623, 824),
		...
		CS_CAM_POS(0, 0, 0, 0x42700000, -13, 29, -645, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, -7, 31, -623, 0),
		CS_CAM_POS(0, 0, 0, 0x42b40000, -2, 33, -601, 0),
		CS_CAM_POS(0, 0, 0, 0x42b40000, -2, 33, -601, 0),
		CS_CAM_POS(-1, 0, 0, 0x0, 0, 0, 0, 0),
	CS_CAM_POS_LIST(763, 1114),
		CS_CAM_POS(0, 0, 0, 0x42700000, -90, 4, -810, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, -84, 6, -806, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, -114, -3, -825, 0),
		...
		CS_CAM_POS(0, 0, 0, 0x42700000, 134, 56, -973, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, -170, 66, -1027, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, -330, 76, -759, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, -242, 50, -512, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, -22, 12, -400, 0),
		CS_CAM_POS(0, 0, 0, 0x42700000, -21, 12, -401, 0),
		CS_CAM_POS(-1, 0, 0, 0x0, 0, 0, 0, 0),
	...
	CS_CAM_FOCUS_POINT_LIST(205, 395),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42700000, 1, 18, -779, 0),
		CS_CAM_FOCUS_POINT(0, 0, 40, 0x42700000, -3, 94, -777, 0),
		CS_CAM_FOCUS_POINT(0, 0, 30, 0x42700000, 0, 156, -756, 0),
		CS_CAM_FOCUS_POINT(0, 0, 30, 0x42700000, 0, 197, -734, 0),
		CS_CAM_FOCUS_POINT(0, 0, 30, 0x42700000, 1, 198, -736, 0),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42700000, 1, 198, -737, 0),
		CS_CAM_FOCUS_POINT(-1, 0, 0, 0x0, 0, 0, 0, 0),
	...
	CS_CAM_FOCUS_POINT_LIST(445, 545),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42700000, 44, 39, -609, 0),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42700000, 44, 39, -609, 0),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42700000, 44, 39, -609, 0),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42700000, 44, 39, -609, 0),
		CS_CAM_FOCUS_POINT(-1, 0, 0, 0x0, 0, 0, 0, 0),
	...
	CS_CAM_FOCUS_POINT_LIST(623, 843),
		...
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42700000, -6, 24, -618, 0),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42700000, -2, 26, -595, 0),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42b40000, -1, 31, -589, 0),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42b40000, -1, 31, -589, 0),
		CS_CAM_FOCUS_POINT(-1, 0, 0, 0x0, 0, 0, 0, 0),
	CS_CAM_FOCUS_POINT_LIST(763, 1163),
		...
		CS_CAM_FOCUS_POINT(0, 0, 13, 0x42700000, 2, 28, -760, 0),
		CS_CAM_FOCUS_POINT(0, 0, 15, 0x42700000, 1, 28, -760, 0),
		CS_CAM_FOCUS_POINT(0, 0, 20, 0x42700000, 0, 28, -759, 0),
		CS_CAM_FOCUS_POINT(0, 0, 25, 0x42700000, 2, 58, -758, 0),
		CS_CAM_FOCUS_POINT(0, 0, 100, 0x42700000, 4, 116, -757, 0),
		CS_CAM_FOCUS_POINT(0, 0, 50, 0x42700000, 6, 116, -758, 0),
		CS_CAM_FOCUS_POINT(-1, 0, 0, 0x0, 0, 0, 0, 0),
	CS_PLAYER_ACTION_LIST(4),
		CS_PLAYER_ACTION(0x0005, 0, 445, 0x0, 0xffff8000, 0x0, 0, -14, -584, 0, -14, -584, 0, 0, 0),
		CS_PLAYER_ACTION(0x0011, 445, 990, 0x0, 0xffff8000, 0x0, 0, -14, -584, 0, -14, -584, 0, 0, 0),
		CS_PLAYER_ACTION(0x003E, 990, 1000, 0x0, 0xffff8000, 0x0, 0, -14, -584, 0, -14, -584, 0, 0, 0),
		CS_PLAYER_ACTION(0x0005, 1000, 1001, 0x0, 0xffff8000, 0x0, 0, -14, -584, 0, -14, -584, 0, 0, 0),
